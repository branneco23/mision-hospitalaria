  ...
  return (
    <nav className={`container ${sticky? 'dark-nav' : ''}`}>
        ...
        <ul className={mobileMenu?'':'hide-mobile-menu'}>
            ...
            <li><Link to='campus' smooth={true} offset={-260} duration={500}>Registros</Link></li>
            <li><Link to='testimonials' smooth={true} offset={-260} duration={500}>Testimonios</Link></li>
            <li><Link to='contact' smooth={true} offset={0} duration={-260} className='btn'>Contactos</Link></li>
        </ul>
